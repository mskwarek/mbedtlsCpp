...
public:
  virtual void SetUp(std::string ciphersuite)
  {
    ...
    if(opt->force_ciphersuite[0] == 0 )
      throw 1;
    opt->server_port = "443";
    opt->ca_file="/home/mkoi/ec_certs/localh.crt";
    opt->crt_file = "/home/mkoi/ec_certs/localh_c.crt";
    opt->key_file = "/home/mkoi/ec_certs/localh_c.pem";
  }
};
...
public:
  virtual void SetUp(std::string ciphersuite){
    ...
    opt->ca_file="/home/mkoi/certs/localhost.crt";
    opt->crt_file = "/home/mkoi/certs/localhost_c.crt";
    opt->key_file = "/home/mkoi/certs/localhost_c.pem";
  }
};
...
public:
  virtual void SetUp(std::string ciphersuite)
  {
    ...
    opt->ca_file="/home/mkoi/certs/localho.crt";
    opt->crt_file = "/home/mkoi/dsacerts/localho_c.crt";
    opt->key_file = "/home/mkoi/dsacerts/localho_c.pem";
  }
};
